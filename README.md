# Movies Browser
![build](https://travis-ci.com/giogus/Movies-Browser.svg?branch=master)
...
Movies Browser is released under the MIT license. [See LICENSE](https://github.com/giogus/Movies-Browser/blob/master/LICENSE) for details.
